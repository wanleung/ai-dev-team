"""MCP tool: send_email - Send an email via SMTP using a registered account."""
...
async def send_email(
    ...
    if account.auth_method == "oauth2" and _require_deps().oauth2_manager:
        oauth2_callback = lambda aid=account_id: _require_deps().oauth2_manager.get_access_token(aid)
